              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <Image
                    ...
                    width={500}
                    height={500}
                    className="h-20 w-20 rounded-lg object-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] lg:h-30 lg:w-30"
                  />
                  <div>
                    <h1 className="font-bold lg:text-xl text-white">
                      {item.company}
                    </h1>
                    <p className="lg:text-lg text-neutral-400">{item.role}</p>
                  </div>
                </div>
              </div>{' '}
            </div>
