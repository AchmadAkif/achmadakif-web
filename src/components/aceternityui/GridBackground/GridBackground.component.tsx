...
export default function GridBackgroundDemo({ position }: { position: string }) {
  return (
    <div
      className={`absolute ${position} flex h-screen w-full items-center justify-center bg-black-100`}
    >
      <div
        className={cn(
          'absolute inset-0',
